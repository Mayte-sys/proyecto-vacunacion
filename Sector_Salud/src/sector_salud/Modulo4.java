...
public class Modulo4 extends JPanel {
    ...
    public Modulo4(CardLayout cardLayout, JPanel contenedor) {
        ...
        // Título
        JLabel titulo = new JLabel("Aplicacion de Vacunas");
        ...
        ImageIcon iconoAltasManuales = cargarImagen("/Recursos/logo_gob_mx.png", 64, 64);
        ImageIcon iconoReportes = cargarImagen("/Recursos/alta_folios.png", 64, 64);
        
        // Nombres y claves para los 2 botones
        String[] nombres = {"Altas", "Altas Manuales", "Reportes"};
        ImageIcon[] iconos = {iconoAltas, iconoAltasManuales, iconoReportes};
        String[] claves  = {"Altas_Vacunacion", "Altas_Manuales", "Reportes_Vacunacion"};
