...
public class Notificaciones extends JPanel {
    ...
    public Notificaciones (CardLayout cardLayout, JPanel contenedor) {
        setBackground(FONDO);
        ...
        JPanel grid = new JPanel(new GridLayout(1, 2, 28, 28));
        ...
        String[] claves  = {"altaNotificacion","altaReportes"};
