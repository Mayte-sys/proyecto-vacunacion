...
public class Modulo1 extends JPanel {
    ...
    public Modulo1(CardLayout cardLayout, JPanel contenedor) {
        setBackground(FONDO);
        setLayout(new BorderLayout());
        setBorder(new EmptyBorder(30, 40, 30, 40));

        // Título
        JLabel titulo = new JLabel("Campaña de Vacunacion");
        ...
        String[] claves  = {"Altas_Campana", "Bajas_Campana", "Modificar_Campana", "Reportes_Campana"};
