...
public class Modulo5 extends JPanel {
    ...
    public Modulo5(CardLayout cardLayout, JPanel contenedor) {
        setBackground(FONDO);
        setLayout(new BorderLayout());
        setBorder(new EmptyBorder(30, 40, 30, 40));

        // Título
        JLabel titulo = new JLabel("ESAVI");
        ...
        String[] nombres = {"Altas", "Reportes"};
        ImageIcon[] iconos = {iconoAltas, iconoReportes};
        String[] claves  = {"Altas_Esavi", "Reportes_Esavi"};
