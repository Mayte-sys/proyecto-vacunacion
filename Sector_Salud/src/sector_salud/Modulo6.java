...
public class Modulo6 extends JPanel {
    ...
    public Modulo6(CardLayout cardLayout, JPanel contenedor) {
        setBackground(FONDO);
        ...
        String[] claves  = {"Altas_Asignaciones", "Bajas_Asignaciones", "Modificar_Asignaciones", "Reportes_Asignaciones"};
